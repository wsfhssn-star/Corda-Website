                  ...
                  <div className="flex items-center gap-3 mb-4">
                    <motion.div 
                      ...
                      whileHover={{ 
                        scale: 1.12, 
                        rotate: 15,
                        backgroundColor: "#fff7ed" // slightly lighter orange bg
                      }}
                      className="w-10 h-10 rounded-xl bg-orange-50 text-brand-orange flex items-center justify-center shrink-0 transition-colors duration-200"
                    >
